class Play extends Phaser.Scene {
    ...
    preload() {
        this.load.image('spaceship2', './assets/newShip.png');
    ...
    create() {
        ...
        this.ship04 = new Spaceship(this, game.config.width + borderUISize*3, borderUISize*5 + borderPadding*2, 'spaceship2', 0, 60).setOrigin(0,0);
